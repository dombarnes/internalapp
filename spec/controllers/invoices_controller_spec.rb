...
describe InvoicesController do
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested invoice" do
        ...
        Invoice.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, :id => invoice.id, :invoice => {'these' => 'params'}
      end

      it "assigns the requested invoice as @invoice" do
        invoice = Invoice.create! valid_attributes
        put :update, :id => invoice.id, :invoice => valid_attributes
        assigns(:invoice).should eq(invoice)
      end
    ...
    describe "with invalid params" do
      it "assigns the invoice as @invoice" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Invoice.any_instance.stub(:save).and_return(false)
        put :update, :id => invoice.id.to_s, :invoice => {}
        assigns(:invoice).should eq(invoice)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested invoice" do
      invoice = Invoice.create! valid_attributes
      expect {
        delete :destroy, :id => invoice.id.to_s
      }.to change(Invoice, :count).by(-1)
    end
