...
RSpec.describe ContractsController, type: :controller  do
  ...
  describe "GET index" do
    it "assigns all contracts as @contracts" do
      ...
      get :index
      assigns(:contracts).to eq([contract])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested contract as @contract" do
      ...
      assigns(:contract).to eq(contract)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new contract as @contract" do
      get :new
      assigns(:contract).to be_a_new(Contract)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created contract as @contract" do
        post :create, :contract => valid_attributes
        assigns(:contract).to be_a(Contract)
        assigns(:contract).to be_persisted
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested contract" do
        ...
        Contract.any_instance.to_receive(:update_attributes).with({'these' => 'params'})
